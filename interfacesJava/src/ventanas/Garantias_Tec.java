 ...
 * @author CPU_SYS
 */
public class Garantias_Tec extends javax.swing.JFrame {
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Garantias_Tec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Garantias_Tec().setVisible(true);
            }
        });
    }
